...
class TestEvents:
    def test_list_events_as_viewer(self, auth_headers):
    ...
    def test_get_event_not_found(self, auth_headers):
    ...
    def test_get_event_trace_not_found(self, auth_headers):
        headers = auth_headers("admin")
        with patch("src.api.routers.operations.get_event_store") as mock_es:
            store = AsyncMock()
            store.get_event.return_value = None
...
class TestApprovals:
    def test_list_approvals_as_admin(self, auth_headers):
        headers = auth_headers("admin")
    ...
    def test_list_approvals_as_viewer_403(self, auth_headers):
        headers = auth_headers("viewer")
        resp = client.get("/api/v1/approvals", headers=headers)
        assert resp.status_code == 403

    def test_approve_event_as_admin(self, auth_headers):
        headers = auth_headers("admin")
        with (
    ...
    def test_approve_event_not_found(self, auth_headers):
        headers = auth_headers("admin")
        with patch("src.api.routers.operations.get_event_store") as mock_es:
            store = AsyncMock()
            store.get_event.return_value = None
    ...
    def test_approve_event_as_viewer_403(self, auth_headers):
        headers = auth_headers("viewer")
...
class TestMetrics:
    def test_get_metrics_as_admin(self, auth_headers):
        headers = auth_headers("admin")
        with patch("src.api.routers.operations.get_event_store") as mock_es:
            store = AsyncMock()
    ...
    def test_timeline_as_admin(self, auth_headers):
        headers = auth_headers("admin")
        with patch("src.api.routers.operations.get_event_store") as mock_es:
            store = AsyncMock()
            store.list_events.return_value = []
...
class TestRules:
    def test_get_version(self, auth_headers):
        headers = auth_headers("viewer")
    ...
    def test_sync_rules_as_admin(self, auth_headers):
        headers = auth_headers("admin")
    ...
    def test_sync_rules_as_viewer_403(self, auth_headers):
        headers = auth_headers("viewer")
        resp = client.post("/api/v1/rules/sync", json={}, headers=headers)
        assert resp.status_code == 403

    def test_download_pack_not_found(self, auth_headers):
    ...
    def test_download_pack_as_viewer_403(self, auth_headers):
